...
const Women = () => {
  ...
  const {isLoading,women} = useSelector((store) =>{
    return {
      women: store.WomenReducer.women,
      isLoading: store.WomenReducer.isLoading
    }
  });
...
console.log(loaction)
  ...
  const slice = women.slice(0, noofElements);
  ...
  useEffect(() => {
    ...
    if (loaction || women.length === 0) {
      ...
      dispatch(getwomenData(getMensParams));
